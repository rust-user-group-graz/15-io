...
\begin{frame}[fragile]{I/O traits}
  ...
  \end{itemize}
  There is no \mintinline{rust}{std::io::BufWrite} trait, but struct \mintinline{rust}{std::io::BufWriter}. \mintinline{rust}{std::io::BufReader} implements \mintinline{rust}{std::io::BufRead}.
